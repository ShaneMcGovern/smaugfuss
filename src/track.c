...
void found_prey(CHAR_DATA *ch, CHAR_DATA *victim)
{
   ...
   if (!can_see(ch, victim))
   {
      ...
      {
      case 0:
         snprintf(buf, MAX_STRING_LENGTH, "Don't make me find you, %.4070s!", victname);
         do_say(ch, buf);
         break;
      case 1:
         ...
         break;
      case 2:
         snprintf(buf, MAX_STRING_LENGTH, "I'm going to tear %.4070s apart!", victname);
         do_yell(ch, buf);
         break;
      case 3:
   ...
   if (xIS_SET(ch->in_room->room_flags, ROOM_SAFE))
   {
      ...
      case 0:
         ...
         snprintf(buf, MAX_STRING_LENGTH, "%.4075s is a bloody coward!", victname);
         do_yell(ch, buf);
         break;
      case 1:
         snprintf(buf, MAX_STRING_LENGTH, "Let's take this outside, %.4070s", victname);
         do_say(ch, buf);
         break;
      case 2:
         snprintf(buf, MAX_STRING_LENGTH, "%.4069s is a yellow-bellied wimp!", victname);
         do_yell(ch, buf);
         break;
      case 3:
   ...
   {
   case 0:
      snprintf(buf, MAX_STRING_LENGTH, "Your blood is mine, %.4074s!", victname);
      do_yell(ch, buf);
      break;
   case 1:
      snprintf(buf, MAX_STRING_LENGTH, "Alas, we meet again, %.4073s!", victname);
      do_say(ch, buf);
      break;
   case 2:
      snprintf(buf, MAX_STRING_LENGTH, "What do you want on your tombstone, %.4058s?", victname);
      do_say(ch, buf);
      break;
   case 3:
