...
void nanny_get_name(DESCRIPTOR_DATA *d, char *argument)
{
   ...
   if (check_playing(d, argument, FALSE) == FALSE)
   {
...
void nanny_get_new_class(DESCRIPTOR_DATA *d, const char *argument)
{
   ...
   {
      if (iRace != RACE_VAMPIRE && race_table[iRace]->race_name && race_table[iRace]->race_name[0] != '\0' && !IS_SET(race_table[iRace]->class_restriction, 1 << ch->Class) && str_cmp(race_table[iRace]->race_name, "unused"))
      {
         if (iRace > 0)
         {
...
void nanny_get_new_race(DESCRIPTOR_DATA *d, const char *argument)
{
   ...
   if (iRace == MAX_PC_RACE || !race_table[iRace]->race_name || race_table[iRace]->race_name[0] == '\0' || iRace == RACE_VAMPIRE || IS_SET(race_table[iRace]->class_restriction, 1 << ch->Class) || !str_cmp(race_table[iRace]->race_name, "unused"))
   {
      ...
      else
      {
         ...
         case 'e':
            if (ch->sex > 2 || ch->sex < 0)
            {
               ...
               i = should_upper ? !can_see(to, ch) ? "It" : capitalize(he_she[URANGE(0, ch->sex, 2)]) : !can_see(to, ch) ? "it"
         ...
         case 'E':
            if (vch->sex > 2 || vch->sex < 0)
            {
               ...
               i = should_upper ? !can_see(to, vch) ? "It" : capitalize(he_she[URANGE(0, vch->sex, 2)]) : !can_see(to, vch) ? "it"
         ...
         case 'm':
            if (ch->sex > 2 || ch->sex < 0)
            {
               ...
               i = should_upper ? !can_see(to, ch) ? "It" : capitalize(him_her[URANGE(0, ch->sex, 2)]) : !can_see(to, ch) ? "it"
         ...
         case 'M':
            if (vch->sex > 2 || vch->sex < 0)
            {
               ...
               i = should_upper ? !can_see(to, vch) ? "It" : capitalize(him_her[URANGE(0, vch->sex, 2)]) : !can_see(to, vch) ? "it"
         ...
         case 's':
            if (ch->sex > 2 || ch->sex < 0)
            {
               ...
               i = should_upper ? !can_see(to, ch) ? "It" : capitalize(his_her[URANGE(0, ch->sex, 2)]) : !can_see(to, ch) ? "it"
         ...
         case 'S':
            if (vch->sex > 2 || vch->sex < 0)
            {
               ...
               i = should_upper ? !can_see(to, vch) ? "It" : capitalize(his_her[URANGE(0, vch->sex, 2)]) : !can_see(to, vch) ? "it"
