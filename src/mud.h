...
#define VALID_LANGS (LANG_COMMON | LANG_ELVEN | LANG_DWARVEN | LANG_PIXIE | LANG_OGRE | LANG_ORCISH | LANG_TROLLISH | LANG_GOBLIN | LANG_HALFLING | LANG_GITH | LANG_GNOME)
/* 19 Languages */
...
#define GET_AC(ch) ((ch)->armor + (IS_AWAKE(ch) ? dex_app[get_curr_dex(ch)].defensive : 0) + VAMP_AC(ch))
...
#define IS_CLANNED(ch) (!IS_NPC((ch)) && (ch)->pcdata->clan && (ch)->pcdata->clan->clan_type != CLAN_ORDER && (ch)->pcdata->clan->clan_type != CLAN_GUILD)

#define IS_ORDERED(ch) (!IS_NPC((ch)) && (ch)->pcdata->clan && (ch)->pcdata->clan->clan_type == CLAN_ORDER)

#define IS_GUILDED(ch) (!IS_NPC((ch)) && (ch)->pcdata->clan && (ch)->pcdata->clan->clan_type == CLAN_GUILD)

#define IS_DEADLYCLAN(ch) (!IS_NPC((ch)) && (ch)->pcdata->clan && (ch)->pcdata->clan->clan_type != CLAN_NOKILL && (ch)->pcdata->clan->clan_type != CLAN_ORDER && (ch)->pcdata->clan->clan_type != CLAN_GUILD)
...
#define MORPHPERS(ch, looker) (can_see((looker), (ch)) ? (ch)->morph->morph->short_desc \
                                                       : "someone")
